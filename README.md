...
```bash
# Buscar una herramienta específica
grep -r "tcpdump" ./sys-admin-guides/

# Leer una guía completa
less sys-admin-guides/awk.md

# Buscar un concepto entre todas las guías
grep -r "MTU\|mtu" sys-admin-guides/*.md
```
