...
**Preguntas:** ¿Qué rango de IP indica fallo de DHCP (APIPA)? ¿Cómo contás las leases activas del servidor DHCP? ¿Cómo diferenciás agotamiento legítimo de un ataque DHCP starvation?

**Ejercicio:** Detectar IPs 169.254.x.x en la red, contar leases activas, identificar si hay un ataque de starvation.

**Evaluación:** detección correcta del síntoma (APIPA), diagnóstico de capacidad del pool, identificación de patrón de ataque.
