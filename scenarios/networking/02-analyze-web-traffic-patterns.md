...
- una ruta con muchas requests → tráfico normal o endpoint principal
- múltiples rutas con 404 → escaneo de directorios
- intentos a rutas sensibles (/admin, /wp-admin) → posible ataque
